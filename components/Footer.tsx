      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p className="mb-4">
            ...
            <a href="https://beian.miit.gov.cn/#/Integrated/index" className="hover:text-foreground transition-colors">域名备案闽ICP备2026003001号-1</a>, <a href="https://beian.mps.gov.cn/#/query/webSearch?code=35010302000932" className="hover:text-foreground transition-colors">公安网监闽公网安备35010302000932号</a>
          </p>
